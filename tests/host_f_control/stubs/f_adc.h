...
/* Minimal f_adc.h stub for host-based unit tests of f_control.c.
 * Declares the real public signatures f_source.h references; the driver
 * bodies are unreferenced and dropped by --gc-sections. */
