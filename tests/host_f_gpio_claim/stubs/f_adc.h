...
/* Minimal f_adc.h stub for host-based unit tests of f_source.c.
 * Declares the real public signatures f_source.c calls (f_adc_read_raw,
 * f_adc_raw_to_voltage, f_adc_ntc_temp); the driver bodies are
 * unreferenced and dropped by --gc-sections. */
