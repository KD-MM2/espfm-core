...
{
    switch (t) {
        case SOURCE_TYPE_NTC:     return SourceType_SOURCE_TYPE_NTC;
        case SOURCE_TYPE_DS18B20: return SourceType_SOURCE_TYPE_DS18B20;
        case SOURCE_TYPE_MANUAL:  return SourceType_SOURCE_TYPE_MANUAL;
        default:                  return SourceType_SOURCE_TYPE_MANUAL;
    }
}
...
{
    switch (t) {
        case SourceType_SOURCE_TYPE_NTC:     return SOURCE_TYPE_NTC;
        case SourceType_SOURCE_TYPE_DS18B20: return SOURCE_TYPE_DS18B20;
        default:                             return SOURCE_TYPE_MANUAL;
    }
}
